...
#include "../Object/Actor/PlayerShot.h"
#include "../Object/Actor/Blood.h"
...
void GameScene::Init(void)
{
	...
	enemy_ = new EnemyManager(player_, stage_, item_, camera_);
	blood_ = new Blood();
	...
	item_->Init(player_, pShot_, camera_);
	enemy_->Init();
	blood_->Init();
...
void GameScene::PauseDraw(void)
{
	...
	DrawString(1920 -375, 500,  "aim感度 ", 0x0ffffff);
	SetFontSize(60);
