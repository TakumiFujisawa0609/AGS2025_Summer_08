...
public:
	...
	static constexpr int BGM1_VOLUME = 143;		// BGM‚Ì‰¹—Êi‚O`‚Q‚T‚Tj
	...
	static constexpr int OPEN_VOLUME = 173;		// ‘–‚é‰¹—Êi‚O`‚Q‚T‚Tj
	static constexpr int CLOSE_VOLUME = 173;		// BGM‚Ì‰¹—Êi‚O`‚Q‚T‚Tj
